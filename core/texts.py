...
MSG_NO_USERNAME = 'Нам с тобой будет сложно общаться, пока ты не сделаешь себе юзернэйм. ' \
                  'Его можно задать в настройках телеграма. А пока часть функций тебе недоступна.'
...
MSG_USER_BANNED = 'Владыка Миров пробуждается... {} предал Сумрак и был принесен в жертву Великому Ктулху!☠️'
