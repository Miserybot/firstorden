...
DB = 'mysql://be7e037166f6fd:9120268b@eu-cdbr-west-01.cleardb.com/heroku_2628e0f251e73f5?charset=utf8mb4?reconnect=true' # Строчка подключения к базе данных (поддерживается только MySql, о формате можно прочитать тут http://docs.sqlalchemy.org/en/latest/dialects/mysql.html)
